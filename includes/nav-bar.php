<nav>
    <a href="/Maiden-Home/" style="text-decoration: none;" id="home-link"><div class="logo">
        ...
        <form action="/maiden-home/product/index.php" method="GET" class="search">
    ...
    <div class="nav-options-wrapper">
        ...
        <a href="/Maiden-Home/cart" class="nav-options"><svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-shopping-cart-icon lucide-shopping-cart">
