...
if (isset($_SESSION['user_id'])) {
    ...
    $stmt_cart = $conn->prepare("SELECT COUNT(cart_id) AS item_count FROM addtocart WHERE user_id = ?");
    if ($stmt_cart) {
...
<nav>
    ...
    <div class="nav-options-wrapper">
        ...
        <a href="/Maiden-Home/cart" class="nav-options">
            <div class="cart-count"><?= $cart_item_count; ?></div>
