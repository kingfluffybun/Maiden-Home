    ...
    <div class="cart-container">
                ...
                <?php foreach ($cart_items as $item): ?>
                    <div class="cart-item">
                        ...
                        <div class="item-info">
                            ...
                            <p class="product-detail">Color: <?php echo htmlspecialchars($item['color']); ?> | Material: <?php echo htmlspecialchars($item['material']); ?> | Size: <?php echo htmlspecialchars($item['size']); ?></p>
        ...
        <div class="cart-right">
            ...
            <div class="summary-row">
                <p>Subtotal</p>
                <p class="black-price">₱<?php echo number_format($subtotal, 2); ?></p>
            </div>
            <div class="summary-row">
                <p>Shipping</p>
            ...
            <div class="summary-row total">
                <p>Total</p>
                <p class="black-price">₱<?php echo number_format($total, 2); ?></p>
            </div>
